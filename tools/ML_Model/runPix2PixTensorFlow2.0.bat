...
set INPUT_DIR="D:\Zhaochen\ML_training_data_augmentation\splittedData"
...
set CUDA_DEVICE=0
set COMMENT="1st_grainBoundary-demorun-zhaochenSystem-4_DLR_1e-4_GAN_1.0_L2_100.0_L1_0."
