...
# note: system name conflict with Zhaochen's machine. (6/1/2024)
...
#    mlOutputRootDir = r'C:\Users\am2195\Desktop\num2img\machineLearning\data\trialNpzData\MeltPoolSim'
    ...
    raise ValueError(f"Unknown host system !!!! {platform.node()}. Probably you are running on a new system/host. "
                     f"Please add one more elif block above with suitable values of varibles for this host")
